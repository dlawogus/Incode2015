...
public class CustomDialog_history extends Dialog{
    ...
    public CustomDialog_history(Context context) {
        // Dialog 배경을 투명 처리 해준다.
        super(context , android.R.style.Theme_Translucent_NoTitleBar);
    }

    public CustomDialog_history(Context context, String title,
    ...
    public CustomDialog_history(Context context, String title, String content,
